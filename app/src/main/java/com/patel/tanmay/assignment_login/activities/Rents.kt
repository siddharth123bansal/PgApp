...
class Rents : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        roomList = ArrayList()
        rentsAdapter = rentsAdapter(this,pgid.toString(),roomList,user, ::fetchData)
            ...
            override fun responseCallback(response: JSONObject) {
                ...
                if(response.getString("rooms").toString().equals("null")){
                    ...
                    if (roomsObj.length() > 0) {
                        ...
                        val roomId = roomsObj.get("_id").toString()
...
//                                val occupation = user.get("occupation").toString()
                                ...
                                val rentPaidArray =
                                    (userList.get(i) as JSONObject).getJSONArray("rentpaid")
